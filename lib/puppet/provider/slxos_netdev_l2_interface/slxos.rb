...
# File           : puppet/provider/slxos_netdev_l2_interface/slxos.rb
# Version        : 06-12-2017
# Description    : 
#
#   This file contains the SLXOS specific code to implement a 
#   netdev_l2_interface.   This module will manage SLXOS switchport
...
Puppet::Type.type(:slxos_netdev_l2_interface).provide(:slxos) do
  @doc = "Manage SLXOS switchport interfaces"
