...
# File           : puppet/provider/slxos_netdev_interface/slxos.rb
# Version        : 06-12-2017
# Description    : 
#
#   This file contains the SLXOS specific code to implement a 
#   netdev_interface.  The netdev_interface resource allows 
#   management of physical Ethernet interfaces on SLXOS systems.
#
...
Puppet::Type.type(:slxos_netdev_interface).provide(:slxos) do
  @doc = "Manage SLXOS physical interfaces"
